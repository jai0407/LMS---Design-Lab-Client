        ...
        <?php if ($this->session->userdata('user_role') =='ADMIN') {
          ...
          <div class="d-flex align-items-center">
            <a href="<?php echo base_url('ImportExport') ?>">
              <button type="button" style="background-color:#B0CB1F" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                <i class="mdi mdi mdi-arrow-right-bold-circle " style=" background:#7b8f0e;"></i> Import bulk lead </button>
            </a>
          </div>
          <?php } ?>
                          ...
                          if (!empty($lead_today)) {
                            foreach ($lead_today as $dashboard) : ?>
                              <tr>
                                ...
                                <td>
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#TodayModal-<?= $dashboard->id; ?>">Remark</button>
                                  <!-- Remark Modal -->
                                  ...
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#TodayLastRemark-<?= $dashboard->id; ?>">Last Remark</button>
                            ...
                            foreach ($lead_Opportunity as $Opportunity) : ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#OpportunityModal-<?= $Opportunity->id; ?>">Remark</button>
                                  <!-- Remark Modal -->
                                  ...
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#OpportunityLastRemark-<?= $Opportunity->id; ?>">Last Remark</button>
                          ...
                          if (!empty($lead_Convert)) {
                            ...
                            foreach ($lead_Convert as $convert) : ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#ConvertModal-<?= $convert->id; ?>">Remark</button>
                                  <!-- Remark Modal -->
                                  ...
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#convertLastRemark-<?= $convert->id; ?>">Last Remark</button>
                          ...
                          if (!empty($lead_recently)) {
                            foreach ($lead_recently as $recently) : ?>
                              <tr>
                                ...
                                <td>
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#recentlyModal-<?= $recently->id; ?>">Remark</button>
                                  <!-- Remark Modal -->
                                  ...
                                  <button type="submit" class="btn btn-#B0CB1F mr-2" style="background-color:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#recentlyLastRemark-<?= $recently->id; ?>">Last Remark</button>
                                  <!-- Last Remark Modal Start -->
