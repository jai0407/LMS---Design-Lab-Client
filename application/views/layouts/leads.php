            ...
            <div class="page-header flex-wrap">
               ...
               ?>
                                ...
                                <a href="<?php echo base_url('ImportExport/export_leads') ?>">
                                    <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" style="background-color:#B0CB1F">
                                        <i class="mdi mdi-arrow-left-bold-circle" style=" background:#7b8f0e;"></i> Export lead </button>
                                </a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                if (!empty($lead)) {
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" class="btn btn-warning mr-2" data-toggle="modal" data-target="#exampleModal-8">Remark</button>
                                                            ...
                                                            <td>
                                                                <div class="text-center">
                                                                    <a href="<?php echo base_url(); ?>Home/editLeads/<?php echo $dashboard->id; ?>" class="btn btn-#B0CB1F" style=" background:#B0CB1F;color:aliceblue">Edit</a>
                                                                </div>
                                                            </td>
