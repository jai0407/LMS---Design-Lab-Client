    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="panel panel-green">
                <div class="panel-heading" style="background-color:#131740; color:white ; padding:10px;border-radius:5px">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url(); ?>home/update_password" method="POST" class="form-sample" id="change_pass">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4"></div>
                            <div class="col-lg-4">
                                <button type="submit" class="btn btn-primary btn-lg btn-block"><i class="mdi mdi-key"></i> Chanage Password</button>
                            </div>
                        </div>
                    </form>
                </div>
