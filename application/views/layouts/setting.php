      ...
      <div class="page-header flex-wrap">
        ...
        <div class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
          <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" style="background-color:#B0CB1F"  data-toggle="modal" data-target="#exampleModal">
              <i class="mdi mdi-plus-circle"  style=" background:#7b8f0e;"></i> Add lead status </button>
        </div>
      </div>
                    ...
                    <?php foreach ($lead_status as $sno => $employees) : ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if (($sno !== 1) && ($sno !== 2)) {
                          ?>
                            <button type="button" class="btn btn-#B0CB1F editbtn"  style=" background:#B0CB1F;color:#ffffff" data-toggle="modal" data-target="#exampleModal-<?= $employees->id; ?>">Edit</button>
                          <?php
                          }
                          ?>
